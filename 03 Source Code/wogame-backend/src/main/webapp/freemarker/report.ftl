            ...
            <div class="main_info detail">
                <div class="log_title" style="margin-top:20px;">
                    <form	id="report_form" action="${basePath}/reportInfo" method="post">
                        起始日期：<input id="startDateStr" type="text" value="${start!}" name="startDate" style="height:22px;"/>&nbsp;&nbsp;
                        截止日期：<input id="endDateStr" type="text" value="${end!}" name="endDate" style=" height:22px;"/>&nbsp;&nbsp;
