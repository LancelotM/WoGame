...
<@template csses=["index"] jses=["keyword"]>
            ...
            <div class="main_info detail">
                ...
                <div class="log_title" style="margin-top:20px;">
                    <form	id="report_form" action="${basePath}/reportInfo" method="post">
                        起始日期：<input id="dateStr" type="text" value="${start!}" name="startDate" style="height:22px;"/>&nbsp;&nbsp;
                        截止日期：<input id="dateStr" type="text" value="${start!}" name="endDate" style="height:22px;"/>&nbsp;&nbsp;
                ...
                <table id="download_info_left" class="detail_tb left">
                    <caption class="table_title"><img class="title_image" src="${basePath}/static/images/icon_table.png" alt=""/><span>游戏下载详情&nbsp;&nbsp;共<span id="totalRecord"></span>条记录</span></caption>
                    <tr class="first_tr">
                        <td>游戏名称</td>
                        <td>下载次数</td>
                    </tr>
