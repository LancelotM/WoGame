...
<script type="application/javascript">
    ...
    function ajaxGetData(pPageNum, callback) {
        ...
        $.getJSON("${ctx}/indexlist/recommend.do", {"pageNum": pPageNum, "pageSize": 10}, function (data) {
            ...
            if (data.items.length != 0) {
                ...
                $.each(data.items, function (index, entry) {
                    ...
                    stringBuffer.push('<div class="hd_l_title">');
                    stringBuffer.push('<div class="hdjianjie">');
                    //游戏竞速
                    stringBuffer.push('</div>');


                    stringBuffer.push('<div class="hdmore">');
...
//2
                    ...
                    stringBuffer.push('<div class="fenlei">');
