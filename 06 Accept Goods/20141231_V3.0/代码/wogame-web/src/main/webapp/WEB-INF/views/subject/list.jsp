...
<script type="application/javascript">
    ...
    function ajaxGetData(pPageNum, callback) {
        ...
        $.getJSON("${ctx}/subject/ajaxlist.do", {"pageNum": pPageNum, "pageSize": 10}, function (data) {
            ...
            if (data.items.length != 0) {
                ...
                $.each(data.items, function (index, entry) {
                    ...
                    stringBuffer.push('<div class="jiaobiao_2">');
                    stringBuffer.push('</div>');
                    stringBuffer.push('<img  src="${ctx}/static/images/gameicon.png" data-src="' + entry.banner_url + '" height="312"/>');

                    stringBuffer.push('</dt>');
                    stringBuffer.push('<dd>' + entry.title + '</dd>');
